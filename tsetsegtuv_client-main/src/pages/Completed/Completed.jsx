...
const Completed = () => {
  // Энд захиалагчийн мэдээлэл хадгалагдсан formData
  const [formData, setFormData] = useState({
    ...
    deliveryTime: "",
    message: "",
    price: 0, // Энэ нь totalAmount-оос ирэх болно
    orders: [], // cart мэдээлэлтэй
  });

  // Захиалагчийн нэр болон утасны дугаарыг харуулах
          ...
          <div className="medeelel md:w-[60%]  ">
            <div className="w-full rounded-lg px-2 py-1 mb-[3%]">
              <div className="bg-[#f2f3f2] py-2 rounded-lg text-left md:text-[24px] text-[18px] px-3 shadow-lg shadow-[#fcd7d7]">
                <p className="font-medium">Нийт төлсөн дүн: {formData.price}₮</p>
              </div>
            </div>
            <div className="w-full rounded-lg px-2 py-1 text-left md: mb-[3%]">
              <div className="md:font-medium font-normal bg-[#f2f3f2] rounded-lg md:text-[24px] text-[14px]  text-wrap px-3 py-5 space-y-2 shadow-lg shadow-[#fcd7d7]">
                <p>Хүлээн авагч: {formData.receiverName}</p>
                <p>Хүлээн авагчийн утасны дугаар: {formData.receiverPhone}</p>
                <p>Хүлээн авагчийн хаяг: {formData.address}</p>
                <p>Захиалагч: {customerName}</p>
                <p>Захиалагчийн утасны дугаар: {customerPhone}</p>
              </div>
            </div>
