    ...
    <div className="p-4 max-w-5xl mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            name="email"
            placeholder="Жишээ: name@mail.com"
        ...
        {delived && (
          <>
            ...
            <div>
              ...
              <input
                name="address"
                placeholder="Байр, гудамж, орц гэх мэт"
      ...
      <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          disabled={isLoading}
          className="px-6 py-3 bg-pink-500 text-white rounded shadow-md hover:bg-pink-600 disabled:opacity-50"
        >
