...
const Gifts = () => {
  ...
  const [isLoading, setIsLoading] = useState(true); // Set to true for initial loading state
  ...
  if (isLoading) {
    return <div className="loading-spinner">Loading...</div>; // Show loading message or spinner
  }
